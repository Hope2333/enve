...
- [Phase 1 roadmap](phase-1-roadmap.md): medium-term plan after the first successful Linux baseline build.
...
- `.github/workflows/linux-baseline.yml` is the active CI lane. `preflight` runs automatically; the full compile job is still manual.
